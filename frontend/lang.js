const translations = {
  "en": {
    ...
    "feat_3_title": "Powered by DeepL Voice",
    "feat_3_desc": "Real-time speech translation with a Voice Activity Detection layer that filters silence, music and applause.",
    "feat_4_title": "Optional Translated Audio",
    "feat_4_desc": "When enabled, translations can be played back as speech with volume and mute controls.",
    ...
    "hiw_s3_desc": "A browser Voice Activity Detection layer streams only real speech to the server, filtering silence, music and applause.",
    "hiw_s4_title": "Smart Translation",
    "hiw_s4_desc": "DeepL Voice transcribes and translates each segment with university-specific terminology awareness.",
    "hiw_s5_title": "Voice Synthesis",
    "hiw_s5_desc": "When translated audio is enabled, the server streams speech to participants alongside the text.",
  ...
  "tr": {
    ...
    "feat_3_title": "DeepL Voice ile Güçlendirildi",
    "feat_3_desc": "Sessizlik, müzik ve alkışı eleyen Konuşma Algılama (VAD) katmanı ile gerçek zamanlı ses çevirisi.",
    "feat_4_title": "İsteğe Bağlı Sesli Çeviri",
    "feat_4_desc": "Etkinleştirildiğinde çeviriler; ses seviyesi ve sessize alma kontrolleriyle sesli olarak dinlenebilir.",
    ...
    "hiw_s3_desc": "Tarayıcıdaki Konuşma Algılama (VAD) katmanı yalnızca gerçek konuşmayı sunucuya iletir; sessizlik, müzik ve alkışı eler.",
    "hiw_s4_title": "Akıllı Çeviri",
    "hiw_s4_desc": "DeepL Voice, her segmenti üniversiteye özel terminoloji bilinciyle yazıya döker ve çevirir.",
    "hiw_s5_title": "Ses Sentezi",
    "hiw_s5_desc": "Sesli çeviri etkinse sunucu, metnin yanı sıra çevrilmiş sesi de katılımcılara akıtır.",
