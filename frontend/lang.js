const translations = {
  "en": {
    ...
    "hiw_s2_desc": "Browser VAD streams only speech to the server, which manages the DeepL Voice connection.",
  ...
  "tr": {
    ...
    "hiw_s2_desc": "Tarayıcı VAD'i yalnızca konuşmayı sunucuya iletir; sunucu DeepL Voice bağlantısını yönetir.",
