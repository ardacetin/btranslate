const translations = {
  "en": {
    ...
    "feat_4_desc": "Listen to translations read aloud with studio-quality AI voices powered by Deepgram Aura.",
    ...
    "hiw_s3_desc": "Deepgram Nova-3 transcribes speech in real-time with built-in voice activity detection — zero hallucination, under 300ms latency.",
    ...
    "hiw_s5_desc": "Deepgram Aura converts translated text to studio-quality audio on the server — first byte in under 250ms.",
  ...
  "tr": {
    ...
    "feat_2_desc": "Dinleyiciler İngilizce, Almanca, Fransızca gibi 10'dan fazla dünya diline anında geçebilir.",
    "feat_3_title": "Yapay Zeka Gücü (Deepgram & GPT-4)",
    "feat_3_desc": "Deepgram Nova-3 ve GPT-4o-mini ile yüksek doğrulukta konuşma tanıma ve bağlam bilinçli çeviri.",
    "feat_4_title": "Stüdyo Kalitesinde Ses (TTS)",
    "feat_4_desc": "Deepgram Aura ile çevirileri stüdyo kalitesinde yapay zeka sesleriyle anında dinleyin.",
    ...
    "hiw_s3_desc": "Deepgram Nova-3, konuşmayı dahili ses algılama ile gerçek zamanlı olarak yazıya döker — sıfır halüsinasyon, 300ms altı gecikme.",
    ...
    "hiw_s5_desc": "Deepgram Aura, çevrilmiş metni sunucu tarafında stüdyo kalitesinde sese dönüştürür — ilk bayt 250ms altında.",
